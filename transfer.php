...
form{
            background-image: url("https://suitsmecard.com/app/uploads/2021/06/bank-transfer.jpg");
...
<section id="nav-bar">
    <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">
        <!---logo is here-->
        <a class="navbar-brand" href="#"><img src="https://images-platform.99static.com//_uV0ROWA5nYX1fri6fg3W05cYJA=/284x0:1784x1500/fit-in/500x500/99designs-contests-attachments/62/62702/attachment_62702349" width="10%"> &nbsp;The Sparks Foundation Bank</a>
...
$username = "Christopher Roy";
$password = "insane_theorist";
$dbname = "CUSTOMER";
$flag=0;
// Create connection
